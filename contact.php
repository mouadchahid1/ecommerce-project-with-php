    ...
    $somme =$row['somme'];
     ...
     echo $currency." ".$somme;
        ...
        <div id="contact-main">
            ...
            <div id="mail">
                <div id="inner">
            <div id="main" style="margin-bottom: 50px;width: 100%;">
            <h1 style="width: 100%">Send Us</h1>
                <a style="width: 100%">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.</a>
            </div>     
            <div id="bar">
                    <div id="in">
                <a>Your name*</a>
                ...
                <input type="text"/>
                    ...
                    <div id="bar" style="width: 98%; height: 130px; ">
                        <div id="in">
                    <a>Body*</a>
                <textarea></textarea>
                        </div>
                    ...
                    <div id="bar" style="width: 98%">
                        <div id="in">
                <input type="button" value="Send Message" style="width: 110px; background: dodgerblue; color:white; padding: 0; cursor: pointer;"/>
                        </div>
                    </div>
