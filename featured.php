    ...
    $somme =$row['somme'];
     ...
     echo $currency." ".$somme;
        ...
        <div id="left">
            ...
            <div id="right">
            <img src="assets/sticker2.png"/>
            </div>
        </div>
        
        <div class="section">
            <a style="margin: 0; margin-bottom: 10px; font-size: 20px">Pricing</a>
        ...
        <div id="pricing">
            ...
            <div id="plan">
            <div id="inner">
                <h1 style="color: dodgerblue">INDIVIDUALS</h1>
                <div id="price">
                    <h3>10$ /</h3>
                    <a> Month</a>
                </div>
                <a style="margin-top: 10px;">Limited users</a>
                <div id="line"></div>
                ...
                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
                <button style="background: dodgerblue; color: white">Get Started</button>
                </div>
            </div>
            <div id="plan">
            <div id="inner">
                <h1 style="color: blueviolet">PRO</h1>
                <div id="price">
                    <h3>50$ /</h3>
                    <a> Month</a>
                </div>
                ...
                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
                <button style="background: blueviolet; color: white">Get Started</button>
                </div>
            </div>
            <div id="plan">
            <div id="inner">
                <h1 style="color: orange">BUSINESS</h1>
                <div id="price">
                    <h3>100$ /</h3>
                    <a> Month</a>
                </div>
            ...
            <div id="plan">
            <div id="inner">
                <h1 style="color: tomato">ENTERPRISE</h1>
                <div id="price">
                    <h3>150$ /</h3>
                    <a> Month</a>
                </div>
                ...
                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
                <button style="background: tomato; color: white">Get Started</button>
                </div>
            </div>
